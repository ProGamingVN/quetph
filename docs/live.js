(() => {
  ...
  function explainCameraError(e) {
    ...
    switch (name) {
      ...
      case 'TrackStartError':
        return 'Camera đang bị ứng dụng/tab khác chiếm dụng.<br>Đóng hẳn các app hoặc tab khác đang dùng camera (kể cả app chạy nền), rồi thử lại.';
  ...
  async function startCamera(preferDeviceId) {
    ...
    try {
      stream = await navigator.mediaDevices.getUserMedia({ audio: false, video: primary });
    } catch (e) {
